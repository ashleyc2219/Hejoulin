            ...
            <div className="sakeintro-title">
              ...
              <div className="box">
                <div className="box2">
                  ...
                  <p>首先，可從酒標上所列的日本酒度及酸度理解酒釀。日本酒度是指酒所含的糖量，較多糖量的會以負值「-」表示，為甘口型，甘即甜的意思，而負值愈大，糖量愈高；較少糖量的會以正值「+」表示，為辛口型，而正值愈大，糖量愈少，「辛」這字，聽上去較難明白，或可以葡萄酒「乾型（Dry）」或香檳的乾型「Brut」的概念理解。</p>
                  <p>同一時間，要考慮的是其酸度，因酸度結合日本酒度，才會真正反映酒釀風格。酸度的基準數為「1.5〜1.7」，若數值高於此，即酸度高，為濃醇型；若數值低於此，即酸度低，為淡麗型。所以，日本清酒常會聽到如「淡麗‧辛口」的形容，意即為酒度低，而含糖少。以來福大吟釀
                    「雫」為例，日本酒度 : +2，即為辛口，酸度 : 1.1，即為淡麗。</p>
                </div>
